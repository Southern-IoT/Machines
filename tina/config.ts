...
export default defineConfig({
  ...
  schema: {
    collections: [
      {
        name: "partsInventory",
        label: "Parts Inventory (Pending Images)",
        ...
        ui: {
          filename: {
            ...
            slugify: (values: Record<string, any>) => {
              // Inventory files are named by their `key` field (auto-generated
              // by scripts/scan-parts.mjs). Read-only — never edit filename here.
        ...
        fields: [
          {
            ...
            isTitle: true,
            description:
              "Stable identifier. Generic concepts: needle-dc27. Brand-scoped: juki-bobbin. Auto-generated by npm run scan-parts.",
          },
          {
            name: "type",
            label: "Concept Type",
            ...
            required: true,
            description:
              "'generic' = industry-standard part, shared across brands (Needle DC×27, 608ZZ Bearing). 'brand-scoped' = same physical part but with brand-specific geometry.",
          },
          {
            name: "label",
            ...
            required: true,
            description:
              "Human-readable concept (e.g. 'Needle (DC×27 system)', 'Bobbin (assembly with case)').",
          },
          {
            name: "brand",
            label: "Brand (null for generic concepts)",
            type: "string",
            description:
              "Brand for brand-scoped concepts. Empty for generic concepts that share across all brands.",
          },
          {
            name: "machines",
            ...
            list: true,
            description:
              "Slugs of every machine file in src/content/machines/ that contains this part.",
          },
          {
            name: "occurrences",
            label: "Total Occurrences",
            type: "number",
            description: "How many part rows across all machines match this concept.",
          },
          {
            name: "hasImage",
            ...
            type: "boolean",
            description:
              "True when a matching entry exists in src/content/parts-library/. Auto-checked by npm run scan-parts.",
          },
          {
            name: "sampleNames",
            ...
            list: true,
            description:
              "Up to 4 real partName strings from the matched rows — useful for verifying the concept matches the right thing.",
          },
        ],
      },
      {
